...
public class QuadrilateralSelectionImageView extends ImageView {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        mBorderPaint.setColor(colorAccent);
        mBorderPaint.setAntiAlias(true);
        mBorderPaint.setStyle(Paint.Style.STROKE);
        mBorderPaint.setStrokeWidth(8);

        mCirclePaint = new Paint();
        mCirclePaint.setColor(ContextCompat.getColor(getContext(), colorAccent));
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (mUpperLeftPoint == null || mUpperRightPoint == null
                || mLowerRightPoint == null || mLowerLeftPoint == null) {
            setDefaultSelection();
        }
    }
